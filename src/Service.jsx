        ...
        <main className='flex flex-col gap-10'>
          ...
          <div className='max-w-[1003px] h-[192px] flex justify-center items-center gap-[140px]'>
            ...
            <RiServiceLine className='bg-[#32342D] p-4 rounded-full text-[#EDAB42]' size={50}/>
              ...
              <small className='text-[#C5C5C5] text-center max-w-[253px] h-[72px]'>From concept to completion,we handle every detail with precision and passion</small>
            </article>
            <article className='max-w-[253px] h-[192px] flex flex-col items-center gap-4'>
            <RiServiceLine className='bg-[#32342D] p-4 rounded-full text-[#EDAB42]' size={50}/>
              <h3 className='text-[#DCDCDC] text-[20px]'>Premium Service</h3>
            ...
            <RiServiceLine className='bg-[#32342D] p-4 rounded-full text-[#EDAB42]' size={50}/>
              <h3 className='text-[#DCDCDC] text-[20px]'>Premium Service</h3>
              <small className='text-[#C5C5C5] max-w-[253px] h-[72px]'>From concept to completion,we handle every detail with precision and passion</small>
            </article>
          </div>
        </main>
    </section>
